                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form class="form-horizontal" action="{{ route('abouts.update', $about->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <img src="{{ asset($about->image) }}" class="image mt-4" height="300" width="400"/>
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <label for="blogEmail" class="col-md-3 form-label">Long Description</label>
                                        <div class="col-md-9">
                                            <textarea class="form-control" type="text" id="summernote" name="long_description">{!! $about->long_description !!}</textarea>
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <label for="number" class="col-md-3 form-label">About title</label>
                                        <div class="col-md-9">
                                            <textarea class="form-control" type="text"  name="title" id="summernote1">{!! $about->title !!}</textarea>
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <label for="number" class="col-md-3 form-label">Short description</label>
                                        <div class="col-md-9">
                                            <textarea class="form-control" type="text" name="short_description" id="summernote2">{!! $about->short_description !!}</textarea>
                                        </div>
                                    </div>
