                        ...
                        <div class="theiaStickySidebar">
                            ...
                            <div class="post-single">
                                <div class="post-single__image">
                                    <img src="assets/img/blog/2.jpg" alt="" class="post-single__image-img">
                                </div>
                                ...
                                <div class="post-single__body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 ">
                                            <div class="block-image">
                                                <img src="assets/img/blog/30.jpg" alt="" class="block-image__img">
                                    ...
                                    <div class="row ">
                                        <div class="col-md-6 ">
                                            <div class="block-image">
                                                <img src="assets/img/blog/1.jpg" alt="" class="block-image__img">
                                                <p class="block-image__caption">Caption can be used to add info</p>
                                            </div>
                                        </div>
                                        <div class="col-md-6 ">
                                            <div class="block-image">
                                                <img src="assets/img/blog/4.jpg" alt="" class="block-image__img">
                                                <p class="block-image__caption">Caption can be used to add info</p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="widget__comments">
                                    ...
                                    <ul class="widget__comments-items">
                                        <li class="widget__comments-item">
                                            <img src="assets/img/user/1.jpg" alt="" class="widget__comments-img">
                                        ...
                                        <li class="widget__comments-item">
                                            <img src="assets/img/user/2.jpg" alt="" class="widget__comments-img">
                                            <div class="widget__comments-content">
                                                <ul class="widget__comments-info list-inline">
