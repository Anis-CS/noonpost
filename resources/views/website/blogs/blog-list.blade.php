                            ...
                            <div class="row">
                                    ...
                                    <div class="post-card post-card--default">
                                        <div class="post-card__image">
                                            <a href="post-default.html" >
                                                <img src="{{ asset('/') }}website/assets/img/blog/30.jpg" alt="">
                                            </a>
                                        </div>
                                        ...
                                        <div class="post-card__content">
                                            ...
                                            <p class="post-card__exerpt">Lorem ipsum dolor sit amet consectetur adipisicing elit. Commodi perspiciatis minima in non harum voluptatum molestias, deleniti repellat obcaecati optio qui voluptate pariatur eius laboriosam provident, quibusdam voluptatem. Consequatur laudantium quae recusandae officiis odio esse a distinctio, labore unde assumenda?
                                            </p>
                                            ...
                                            <ul class="post-card__meta list-inline">
                                                ...
                                                <li class="post-card__meta-item"> <span class="dot"></span> 2 comments</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="post-card post-card--default">
                                        <div class="post-card__image">
                                            <a href="post-default.html" >
                                                <img src="{{ asset('/') }}website/assets/img/blog/31.jpg" alt="">
                                            </a>
                                        </div>
                                ...
                                <div class="col-12">
                                    <div class="post-card post-card--default">
                                        <div class="post-card__image">
                                            <a href="post-default.html" >
                                                <img src="{{ asset('/') }}website/assets/img/blog/32.jpg" alt="">
                                            </a>
                                        </div>
                                ...
                                <div class="col-12">
                                    <div class="post-card post-card--default">
                                        <div class="post-card__image">
                                            <a href="post-default.html" >
                                                <img src="{{ asset('/') }}website/assets/img/blog/33.jpg" alt="">
                                            </a>
                                        </div>
